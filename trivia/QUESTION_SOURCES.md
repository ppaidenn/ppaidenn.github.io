...
- All challenge and legacy prompts ask for one determinate answer in Speak It mode. Multiple-choice answers, when that mode is selected, are drawn from the same subject pool as the correct answer instead of unrelated, obvious distractors.
