...
- `username_signup_lookup_schema.sql`: signup helper RPC:
  - `is_signup_username_taken`
...
11. `backend/auth/username_signup_lookup_schema.sql`
12. `backend/auth/username_signin_lookup_schema.sql`
13. `backend/push/push_subscriptions_schema.sql`
14. `backend/calendar/events_schema.sql`
